...
set ( LIBFTDI_FOUND 1 )
set ( LIBFTDI_USE_FILE     "/tmp/openocd-chipsalliance-built-windows/lib/cmake/libftdi1/UseLibFTDI1.cmake" )

set ( LIBFTDI_DEFINITIONS  "" )
set ( LIBFTDI_INCLUDE_DIR  "/tmp/openocd-chipsalliance-built-windows/include/libftdi1" )
set ( LIBFTDI_INCLUDE_DIRS "/tmp/openocd-chipsalliance-built-windows/include/libftdi1" )
set ( LIBFTDI_LIBRARY      "ftdi1" )
set ( LIBFTDI_LIBRARIES    "ftdi1;/tmp/openocd-chipsalliance-built-windows/lib/libusb-1.0.a" )
set ( LIBFTDI_STATIC_LIBRARY      "ftdi1.a" )
set ( LIBFTDI_STATIC_LIBRARIES    "ftdi1.a;/tmp/openocd-chipsalliance-built-windows/lib/libusb-1.0.a" )
set ( LIBFTDIPP_LIBRARY    "" )
set ( LIBFTDIPP_LIBRARIES  "" )
set ( LIBFTDI_LIBRARY_DIRS "/tmp/openocd-chipsalliance-built-windows/bin" )
set ( LIBFTDI_ROOT_DIR     "/tmp/openocd-chipsalliance-built-windows" )
